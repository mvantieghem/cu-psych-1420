...
Use the code you wrote in your Project 1 to create a new variable for overall Regret score in the `IntroSurvey` dataframe called `regret_total`.
...
```{r}
t_age_handed <- t.test(age ~ handed, data = IntroSurvey[!is.na(IntroSurvey$handed), ])
